odoo.define('odoo_customize_brand.UserMenu', function (require) {
    "use strict";
    ...
    //避免错误，要再定义
    var documentation_url = 'https://www.creworker.com';
    var documentation_dev_url = 'https://www.creworker.com';
    var support_url = 'https://www.creworker.com';
    var account_title = 'My Account';
    var account_url = 'https://www.creworker.com';
            ...
            self._rpc({
                ...
                _.each(res, function (lang) {
                    ...
                    lang_list += '<a role="menuitem" href="#" class="dropdown-item" data-lang-menu="lang" data-lang-id="' + lang['code']
                        + '"><img class="flag" src="odoo_customize_brand/static/src/img/flags/' + lang['code'] + '.png"/>' + lang['name'] + a + '</a>';
                });
